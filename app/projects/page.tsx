...
const FeatureProject = ({
  ...
  return (
    <article className="w-full flex items-center justify-between rounded-3xl border border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl">
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6">
        ...
        <div className="mt-2 flex items-center">
          <MotionLink width={10} href={github}>
            <GitHub />
          </MotionLink>
          <Link
            className="ml-4 rounded-lg bg-dark text-light p-1.5 px-6 text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark"
            href={link}
            target="_blank"
          >
            Visit Project
...
const Project = ({ type, title, img, link, github }: ProjectProps) => {
  return (
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-dark bg-light p-6 relative">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <div className="w-full mt-2 flex items-center justify-between">
          ...
          <MotionLink width={8} href={github}>
            <GitHub />
          </MotionLink>
        </div>
      </div>
